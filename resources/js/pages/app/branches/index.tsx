...
export default function BranchesIndex() {
    ...
    const columns = React.useMemo<ColumnDef<Organization>[]>(() => [
        ...
        createSortableColumn<Organization>('Organização / Empresa', 'organization.name'),
                    ...
                    actions: [
                        {
                            ...
                            type: 'link',
                            href: (inventory: Organization) => route('branches.show', inventory.id)
                        },
                        {
                            label: 'Histórico',
                    ...
                    actions: [
                        {
                            ...
                            onClick: async (inventory: Organization, onRefresh) => {
                                try {
                                    await api.delete(route('api.v2.branches.destroy', inventory.id));
                                    if (onRefresh) {
                                        onRefresh();
                                    }
                                } catch (error) {
                ...
                <div className="space-y-6">
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <DataTableServer
                            ...
                            storageKey="branches-table-bulk"
